...
(function (factory) {
    ...
    var Comments = {
        ...
        createProfilePictureElement: function(src, userId,fullname) {
            ...
            var     initials = fullname.split(' ')[0].charAt(0).toUpperCase() + fullname.split(" ")[1].charAt(0).toUpperCase()
            var     avatarWidth = 40
            var     avatarHeight = 40
            var     charIndex = initials.charCodeAt(0) - 65;
            var     colorIndex = charIndex % 19;
            var      avatarElement = $('<div/>').css({
            ...
            if(src) {
              var profilePicture = $('<div/>').css({
                ...
                var profilePicture = avatarElement;
                // var profilePicture = $('<i/>', {
                //     'class': 'fa fa-user'
                // });
            }
            profilePicture.addClass('profile-picture');
            profilePicture.addClass('avatar-initials');
            profilePicture.attr('data-user-id', userId);
            profilePicture.attr('data-name', fullname);
        ...
        createCommentingFieldElement: function(parentId, existingCommentId, isMain) {
            ...
            if(existingCommentId) {
                ...
                profileFullname = this.commentsById[existingCommentId].fullname
            // New comment was created
            } else {
                profilePictureURL = this.options.profilePictureURL;
                userId = this.options.creator;
                profileFullname = this.options.youText
                attachments = [];
            }

            var profilePicture = this.createProfilePictureElement(profilePictureURL, userId,profileFullname);
            ...
            if(this.options.enablePinging) {
                textarea.textcomplete([{
                    ...
                    template: function(user) {
                        ...
                        var profilePictureEl = self.createProfilePictureElement(user.profile_picture_url,null,user.fullname);
        ...
        createCommentWrapperElement: function(commentModel) {
            ...
            // Profile picture
            var profilePicture = this.createProfilePictureElement(commentModel.profilePictureURL, commentModel.creator,commentModel.fullname);
